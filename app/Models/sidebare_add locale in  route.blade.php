...
<div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
           ...
           <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li    @if($routename=='admin.maincategories')  class="active" @endif   ><a class="menu-item" href="{{route('admin.maincategories',app()->getLocale())}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل    </a>
                    </li>
                    <li  @if($routename=='admin.maincategories.create')  class="active" @endif ><a class="menu-item" href="{{route('admin.maincategories.create',app()->getLocale())}}"
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                  ...
                  <ul class="menu-content">
                      <li  @if($routename=='admin.subcategories')  class="active" @endif  ><a class="menu-item" href="{{route('admin.subcategories',app()->getLocale())}}"
                                            data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                      </li>
                      <li  @if($routename=='admin.subcategories.create')  class="active" @endif  >
                      <a class="menu-item" href="{{route('admin.subcategories.create',app()->getLocale())}}" data-i18n="nav.dash.crypto">أضافة
                              قسم فرعي جديد </a>
                      </li>
                  </ul>
              </li>
              ...
              <span class="menu-title" data-i18n="nav.invoice.main">المنتجات</span>
           <span class="badge badge badge-info float-right mr-2"> {{\App\Models\product::count()}}</span>                                                      
                  </a>
               
                                                                                   <ul class="menu-content">
                     <li  @if($routename=='admin.products')  class="active" @endif  ><a class="menu-item" href="{{route('admin.products',app()->getLocale())}}" data-i18n="nav.invoice.invoice_summary">   عرض كل المنتجات
                           </a>
                    </li>
                      <li  @if($routename=='admin.products.create')  class="active" @endif  ><a class="menu-item" href="{{route('admin.products.create',app()->getLocale())}}" data-i18n="nav.invoice.invoice_template"> 
                    إضافة منتج    </a>
                    </li>
             ...
             <li class="nav-item"><a href=""><i class="la la-group"></i>
                      <span class="menu-title" data-i18n="nav.dash.main">طلبات سلة التسوق  </span>
                      <span
                          class="badge badge badge-success badge-pill float-right mr-2">{{\App\Models\Order::count()}}</span>
                  </a>
                  <ul class="menu-content">
                       
                       <li  @if($routename=='admin.orders')  class="active" @endif  ><a class="menu-item" href="{{route('admin.orders','New',app()->getLocale())}}" data-i18n="nav.invoice.invoice_template"> 
                       
                        عرض الطلبات الجديده 
                         <span
                          class="badge badge badge-danger badge-pill float-right mr-2">{{\App\Models\Order::where('order_status','New')->count()}}</span></a>
                      </li>
                    <li  @if($routename=='admin.orders')  class="active" @endif  ><a class="menu-item" href="{{route('admin.orders',app()->getLocale())}}" data-i18n="nav.invoice.invoice_template"> 
            ...
            <li class=" nav-item"><a href="#"><i class="la la-paint-brush"></i><span class="menu-title"
                                                                                     data-i18n="nav.color_palette.main">خصائص المنتجات</span></a>
                <ul class="menu-content">
                     <li  @if($routename=='admin.attributes')  class="active" @endif  ><a class="menu-item" href="{{route('admin.attributes',app()->getLocale())}}" data-i18n="nav.invoice.invoice_summary">   عرض  
                           </a>
                    </li>
                      <li  @if($routename=='admin.attributes.create')  class="active" @endif  ><a class="menu-item" href="{{route('admin.attributes.create',app()->getLocale())}}" data-i18n="nav.invoice.invoice_template"> 
                    إضافة      </a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-paint-brush"></i><span class="menu-title"
                                                                                     data-i18n="nav.color_palette.main">الاحجام ووحدات القياس</span></a>
                <ul class="menu-content">
                     <li  @if($routename=='admin.sizes')  class="active" @endif  ><a class="menu-item" href="{{route('admin.sizes',app()->getLocale())}}" data-i18n="nav.invoice.invoice_summary">   عرض  
                           </a>
                    </li>
                      <li  @if($routename=='admin.sizes.create')  class="active" @endif  ><a class="menu-item" href="{{route('admin.sizes.create',app()->getLocale())}}" data-i18n="nav.invoice.invoice_template"> 
                    إضافة      </a>
                    </li>
...
<li class=" nav-item"><a href="#"><i class="la la-paint-brush"></i><span class="menu-title"
                                                                                     data-i18n="nav.color_palette.main">الالوان</span></a>
                <ul class="menu-content">
                     <li  @if($routename=='admin.colors')  class="active" @endif  ><a class="menu-item" href="{{route('admin.colors',app()->getLocale())}}" data-i18n="nav.invoice.invoice_summary">   عرض  
                           </a>
                    </li>
                      <li  @if($routename=='admin.colors.create')  class="active" @endif  ><a class="menu-item" href="{{ route('admin.colors.create',app()->getLocale()) }}" data-i18n="nav.invoice.invoice_template"> 
                    إضافة      </a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-paint-brush"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                     <li  @if($routename=='admin.coupons')  class="active" @endif  ><a class="menu-item" href="{{route('admin.coupons',app()->getLocale())}}" data-i18n="nav.invoice.invoice_summary">   عرض  
                           </a>
                    </li>
                      <li  @if($routename=='admin.coupons.create_update')  class="active" @endif  ><a class="menu-item" href="{{route('admin.coupons.create_update',app()->getLocale())}}" data-i18n="nav.invoice.invoice_template"> 
                    إضافة      </a>
                    </li>

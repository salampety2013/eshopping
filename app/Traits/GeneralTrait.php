...
trait GeneralTrait
{
    ...
    public function returnError($errNum, $msg,$data=null)
    {
    ...
    public function returnErrors($errNum, $msg,$data=[])
    {
        return response()->json([
            'status' => false,
            'errNum' => $errNum,
    ...
    public function returnSuccessMessages($msg = "", $errNum = "S000",$data=[])
    {
        return [
            'status' => true,
            'errNum' => $errNum,
    ...
    public function returnValidationErrorAll($code = "E001", $validator)
    {
